Scheme
{
	Fonts
	{
		"DefaultFixedOutline" //edited by INsane 2010 for small netgraph font on all screen sizes
        {
            ...
            {
                "name"         "Lucida Console" [$WINDOWS] // Standard is "Lucida Console" Options are "Microsoft Sans Serif" "Lucida Console" "Impact" "Lucida Console MT" and the best for small = "Haettenschweiler" but is a MS office and Win7 font, can be downloaded, google "Haettenschweiler" and install in C:/Windows/Fonts
                "name"         "Lucida Console" [$X360]    //"Lucida Console"
                "name"         "Lucida Console" [$POSIX] // Apple Mac OS "Lucida Console" (default) Best small font = "Lucida Console" Mac Installation location: /Library/Fonts and is default on Mac OS
                "tall"         "11" [$POSIX]  // "11"
                "tall"         "10" //good positioning is ... "net_graphpos 183" and "net_graphheight 30" and ensure you select "antialias"  "1" with all others off with "Lucida Console" font.
                "tall_lodef" "15" //"15"
                "tall_hidef" "20" //"20" 
            ...
            "2" //For screen heights between 600 and 767 (eg 4:3 aspect Width 800X600 High, ... 16:9 aspect Width 1152x648 High.)
            {
                ...
                "name"         "Lucida Console" [$POSIX] // Apple Mac OS "Lucida Console" (default) Best small font = "Lucida Console" Mac Installation location: /Library/Fonts and is default on Mac OS
                "tall"         "12" [$POSIX]  // "11"                
                "tall"         "12" //good positioning is ... "net_graphpos 190" and "net_graphheight 45" and ensure you select "antialias"  "1" with all others off with "Lucida Console" font.
                "tall_lodef" "15" //"15"
                "tall_hidef" "20" //"20"                
                "weight"     "0"
                "range"         "0x0000 0x017F" //    Basic Latin, Latin-1 Supplement, Latin Extended-A
            ...
            "5" //For screen heights between 1200 and 6000 (6000...wow that's freaking huge!) (eg 4:3 aspect Width 1600X1200 High... 16:10 aspect Width 1920x1200 High.... and beyond) 
            {
                "name"         "Lucida Console" [$WINDOWS] // Standard is "Lucida Console" Options are "Microsoft Sans Serif" "Lucida Console" "Impact" "Lucida Console MT" and the best for small = "Haettenschweiler" but is a MS office and Win7 font, can be downloaded, google "Haettenschweiler" and install in C:/Windows/Fonts
                "name"         "Lucida Console" [$X360]    //"Lucida Console"
                "name"         "Lucida Console" [$POSIX] // Apple Mac OS "Lucida Console" (default) Best small font = "Lucida Console" and "Lucida Console" Mac Installation location: /Library/Fonts and is default on Mac OS
                "tall"         "19" [$POSIX]  // "11"                
